  ...
  static ThemeData _buildTheme() {
    ...
    return _theme.copyWith(
      ...
      textTheme: _theme.textTheme.copyWith(
        headline6: _theme.textTheme.headline6
            .copyWith(fontFamily: _displayFont, fontWeight: FontWeight.w900),
        ...
        bodyText2: _theme.textTheme.bodyText2.copyWith(
            fontFamily: _textFont, fontWeight: FontWeight.w300, fontSize: 24.0),
        bodyText1: _theme.textTheme.bodyText1
            .copyWith(fontFamily: _textFont, fontSize: 20.0),
        caption: _theme.textTheme.caption
            .copyWith(fontFamily: _textFont, fontSize: 18.0),
        button: _theme.textTheme.button.copyWith(
            fontFamily: _textFont, fontSize: 16.0, fontWeight: FontWeight.w400),
        overline: _theme.textTheme.overline.copyWith(
            fontFamily: _textFont, fontSize: 12.0, fontWeight: FontWeight.w300),
      ),
      tooltipTheme: TooltipThemeData(
        ...
        textStyle: TextStyle(
            fontFamily: _textFont, fontSize: 13.0, color: Colors.grey[900]),
      ),
